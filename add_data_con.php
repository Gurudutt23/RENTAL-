...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   print_r($_FILES);
    ...
    echo $image;
    $sql = "INSERT INTO property_master (`location`, `property_type`, `no_room`, `room_type`, `no_bed`, `no_bath`, `max_occu`, `kitchen`, `parking`, `descr`, `price`, `img`,`uid`) VALUES ('$location', '$property_type', $no_room, '$room_type', $no_bed, $no_bath, $max_occu, '$kitchen', '$parking', '$descr', $price,'$image',$uid)";
